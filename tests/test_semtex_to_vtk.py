...
from semtex_fieldio.pyvista_export import semtex_to_unstructured_grid, write_vtu, semtex_to_multiblock, write_vtm
from pathlib import Path


mesh_path = Path("./data/koal1.msh")
mesh = Mesh.from_file(mesh_path)

data_path = Path("./data/koal1.1200.chk")
...
write_vtm(vtm_file, "./tmp/koal1.1200.vtm")
