...
from .vtk_export_helpers import mesh_to_block_arrays, field_to_block_point_data
...
def mesh_to_structured_block(mesh: Mesh, element_id: int, like_tec: bool = False, wrap_z=False) -> pv.StructuredGrid:
    ...
    """
    return pv.StructuredGrid(*mesh_to_block_arrays(mesh, element_id, like_tec, wrap_z))
